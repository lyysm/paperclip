    ...
    <div className="space-y-4">
      <div className="space-y-1">
        ...
        {lastErrorIsActive && agent.errorReason && (
          <PropertyRow label={t("agentProperties.errorReason", { defaultValue: "Error reason" })}>
      ...
      <div className="space-y-1">
        ...
        {runtimeState?.lastError && (
          <PropertyRow
            label={
              lastErrorIsActive
                ? t("agentProperties.lastError", { defaultValue: "Last error" })
                : t("agentProperties.lastRunError", { defaultValue: "Last run error" })
            }
          >
            <span
              className={
