...
export function CommandPalette() {
  ...
  return (
    <CommandDialog open={open} onOpenChange={(v) => {
      ...
      <CommandInput
        placeholder={t("commandPalette.placeholder", { defaultValue: "Search tasks, agents, projects..." })}
        value={query}
      ...
      <CommandList>
        <CommandEmpty>
          {showSearchAll ? (
            <span>
              {t("commandPalette.emptyNoMatches", { defaultValue: "No quick task matches. Press" })}{" "}
              <kbd className="rounded border border-border bg-muted px-1 py-0.5 text-(length:--text-nano)">↵</kbd>{" "}
              {t("commandPalette.emptyAction", { defaultValue: "to search all or keep typing to refine." })}
            </span>
          ) : (
            t("commandPalette.emptyNoResults", { defaultValue: "No results found." })
          )}
        </CommandEmpty>

        {showSearchAll ? (
          <CommandGroup heading={t("commandPalette.headingSearch", { defaultValue: "Search" })}>
            <CommandItem
        ...
        <CommandGroup heading={t("commandPalette.headingQuickFilters", { defaultValue: "Quick filters" })}>
        ...
        <CommandGroup heading={t("commandPalette.headingActions", { defaultValue: "Actions" })}>
          <CommandItem
            onSelect={() => {
              setOpen(false);
              openNewIssue();
          ...
          >
            ...
            {t("commandPalette.createNewTask", { defaultValue: "Create new task" })}
          ...
          {onIssueDetail && fileViewerEnabled && (
            ...
            >
              ...
              {t("commandPalette.openFileInIssue", { defaultValue: "Open file in this issue..." })}
        ...
        <CommandGroup heading={t("commandPalette.headingPages", { defaultValue: "Pages" })}>
        ...
        {visibleIssues.length > 0 && (
          <>
            <CommandSeparator />
            <CommandGroup heading={t("nav.tasks", { defaultValue: "Tasks" })}>
