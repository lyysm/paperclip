    ...
    <div className="flex flex-col items-center justify-center min-h-(--sz-60vh) px-8">
      <div className="text-center mb-10">
        ...
        <p className="text-sm text-muted-foreground mt-2">
          {t("onboarding.frontDoor.howToStart", {
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 max-w-lg w-full">
        ...
        >
          ...
          <div>
            <h3 className="font-semibold text-sm">
              {t("onboarding.frontDoor.buildCompany", { defaultValue: "Build a new company" })}
            </h3>
            <p className="text-xs text-muted-foreground mt-1">
              {t("onboarding.frontDoor.buildCompanyDescription", {
                defaultValue:
        ...
        >
          ...
          <div>
            <h3 className="font-semibold text-sm">
              {t("onboarding.frontDoor.addAgents", { defaultValue: "Add agents to your org" })}
            </h3>
            <p className="text-xs text-muted-foreground mt-1">
              {t("onboarding.frontDoor.addAgentsDescription", {
