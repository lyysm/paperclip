...
export function IssueSiblingNavigation({ navigation, linkState }: IssueSiblingNavigationProps) {
  ...
  return (
    <nav
      aria-label={t("issueSiblingNavigation.navLabel", { defaultValue: "Sub-task navigation" })}
...
function SiblingLink({
  ...
  const ariaDirection = direction === "previous"
    ? t("issueSiblingNavigation.previousSubTask", { defaultValue: "Previous sub-task" })
    : t("issueSiblingNavigation.nextSubTask", { defaultValue: "Next sub-task" });
  ...
  return (
    <Link
      ...
      aria-label={t("issueSiblingNavigation.ariaLabel", { defaultValue: "{{direction}}: {{identifier}} - {{title}}", direction: ariaDirection, identifier, title: issue.title })}
      className={cn(
