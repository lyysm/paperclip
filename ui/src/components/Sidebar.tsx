      ...
      <nav className="flex-1 min-h-0 overflow-y-auto scrollbar-auto-hide flex flex-col gap-4 pointer-coarse:gap-3 px-3 py-2">
        <div className="flex flex-col gap-0.5">
          ...
          <SidebarNavItem
            ...
            badgeLabel={t("nav.unreadBadge", { defaultValue: "unread" })}
          ...
          {showStatusCards ? (
            <SidebarNavItem
              to="/status"
              label={t("nav.status", { defaultValue: "Status" })}
              icon={LayoutGrid}
              textBadge={t("nav.betaBadge", { defaultValue: "beta" })}
            />
          ) : null}
        ...
        <SidebarSection label={t("nav.work", { defaultValue: "Work" })} collapsible={{ open: workOpen, onOpenChange: setWorkOpen }}>
          ...
          {showCases ? (
            <SidebarNavItem
              to="/cases"
              label={t("nav.cases", { defaultValue: "Cases" })}
              icon={Layers}
              textBadge={t("nav.betaBadge", { defaultValue: "beta" })}
            />
          ) : null}
        ...
        <SidebarSection
          label={t("nav.company", { defaultValue: "Company" })}
