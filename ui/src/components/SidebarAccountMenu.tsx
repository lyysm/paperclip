...
export function SidebarAccountMenu({
  ...
  const secondaryLabel =
    ...
    (deploymentMode === "authenticated"
      ? t("accountMenu.signedIn", { defaultValue: "Signed in" })
      : t("accountMenu.localWorkspaceBoard", { defaultValue: "Local workspace board" }));
  const accountBadge = deploymentMode === "authenticated"
    ? t("accountMenu.accountBadge", { defaultValue: "Account" })
    : t("accountMenu.localBadge", { defaultValue: "Local" });
      ...
      <Popover open={open} onOpenChange={setOpen}>
        <PopoverTrigger asChild>
          <button
            ...
            aria-label={t("accountMenu.open", { defaultValue: "Open account menu" })}
          >
            <Avatar size="sm">
        ...
        >
          ...
          <div className="-mt-8 px-4 pb-4">
            ...
            <div className="mt-4 space-y-1">
              ...
              />
              <MenuAction
                label={t("accountMenu.feedback", { defaultValue: "Feedback" })}
                ...
                >
                  ...
                  <span className="min-w-0 flex-1">
                    ...
                    <span className="block text-xs text-muted-foreground">
                      {t("accountMenu.endSession", { defaultValue: "End this browser session." })}
                    </span>
                  </span>
                </button>
              ) : null}
