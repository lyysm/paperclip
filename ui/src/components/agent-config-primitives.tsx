  ...
  return (
    <>
      ...
      <Dialog open={open} onOpenChange={setOpen}>
        <DialogContent>
          <DialogHeader>
            <DialogTitle>{t("agentConfig.pathInstructions.manualTitle", { defaultValue: "Specify path manually" })}</DialogTitle>
            <DialogDescription>
              {t("agentConfig.pathInstructions.manualDescription", { defaultValue: "Browser security blocks apps from reading full local paths via a file picker. Copy the absolute path and paste it into the input." })}
            </DialogDescription>
          </DialogHeader>
          <div className="space-y-4 text-sm">
            <section className="space-y-1.5">
              <p className="font-medium">{t("agentConfig.pathInstructions.manualMacTitle", { defaultValue: "macOS (Finder)" })}</p>
              <ol className="list-decimal space-y-1 pl-5 text-muted-foreground">
                <li>{t("agentConfig.pathInstructions.manualMacStep1", { defaultValue: "Find the folder in Finder." })}</li>
                <li>{t("agentConfig.pathInstructions.manualMacStep2", { defaultValue: "Hold Option and right-click the folder." })}</li>
                <li>{t("agentConfig.pathInstructions.manualMacStep3", { defaultValue: "Click \"Copy <folder name> as Pathname\"." })}</li>
                <li>{t("agentConfig.pathInstructions.manualMacStep4", { defaultValue: "Paste the result into the path input." })}</li>
              </ol>
            ...
            <section className="space-y-1.5">
              <p className="font-medium">{t("agentConfig.pathInstructions.manualWindowsTitle", { defaultValue: "Windows (File Explorer)" })}</p>
              <ol className="list-decimal space-y-1 pl-5 text-muted-foreground">
                <li>{t("agentConfig.pathInstructions.manualWindowsStep1", { defaultValue: "Find the folder in File Explorer." })}</li>
                <li>{t("agentConfig.pathInstructions.manualWindowsStep2", { defaultValue: "Hold Shift and right-click the folder." })}</li>
                <li>{t("agentConfig.pathInstructions.manualWindowsStep3", { defaultValue: "Click \"Copy as path\"." })}</li>
                <li>{t("agentConfig.pathInstructions.manualWindowsStep4", { defaultValue: "Paste the result into the path input." })}</li>
              </ol>
              <p className="rounded-md bg-muted px-2 py-1 font-mono text-xs">
            ...
            <section className="space-y-1.5">
              <p className="font-medium">{t("agentConfig.pathInstructions.manualTerminalTitle", { defaultValue: "Terminal fallback (macOS/Linux)" })}</p>
              <ol className="list-decimal space-y-1 pl-5 text-muted-foreground">
                <li>{t("agentConfig.pathInstructions.manualTerminalStep1", { defaultValue: "Run cd /path/to/folder." })}</li>
                <li>{t("agentConfig.pathInstructions.manualTerminalStep2", { defaultValue: "Run pwd." })}</li>
                <li>{t("agentConfig.pathInstructions.manualTerminalStep3", { defaultValue: "Copy the output and paste it into the path input." })}</li>
              </ol>
            </section>
          </div>
          <DialogFooter>
