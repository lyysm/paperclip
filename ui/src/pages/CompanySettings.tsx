    ...
    <div className="max-w-6xl space-y-8">
      ...
      <div className="max-w-2xl space-y-4">
        ...
        <div className="space-y-3">
          <Field
            label={t("companySettings.companyName", { defaultValue: "Company name" })}
            hint={t("companySettings.companyNameHint", { defaultValue: "The display name for your company." })}
          >
            <input
          ...
          <Field
            label={t("companySettings.description", { defaultValue: "Description" })}
      ...
      <div className="max-w-2xl space-y-4">
        <div className="text-xs font-medium text-muted-foreground uppercase tracking-wide">
          {t("companySettings.appearance", { defaultValue: "Appearance" })}
        </div>
        <div className="space-y-3">
          <div className="flex items-start gap-4">
            ...
            <div className="flex-1 space-y-3">
              <Field
                label={t("companySettings.logo", { defaultValue: "Logo" })}
                ...
                <div className="space-y-2">
                    ...
                    <div className="flex items-center gap-2">
                      ...
                      >
                        {clearLogoMutation.isPending
                          ? t("companySettings.removing", { defaultValue: "Removing..." })
                          : t("companySettings.removeLogo", { defaultValue: "Remove logo" })}
                      </Button>
                    </div>
                  )}
                    ...
                    <span className="text-xs text-destructive">
                      {logoUploadError ??
                        (logoUploadMutation.error instanceof Error
                          ...
                          : t("companySettings.logoUploadFailed", { defaultValue: "Logo upload failed" }))}
                    </span>
                  )}
                  ...
                  {logoUploadMutation.isPending && (
                    <span className="text-xs text-muted-foreground">
                      {t("companySettings.uploadingLogo", { defaultValue: "Uploading logo..." })}
                    </span>
                  )}
                </div>
              </Field>
              <Field
                label={t("companySettings.brandColor", { defaultValue: "Brand color" })}
              ...
              >
                <div className="flex items-center gap-2">
                  ...
                  {brandColor && (
                    ...
                    >
                      {t("companySettings.clear", { defaultValue: "Clear" })}
                    </Button>
                  )}
                </div>
              </Field>
              <Field
                label={t("companySettings.attachmentLimit", { defaultValue: "Attachment size limit" })}
              ...
              >
                <div className="flex flex-col gap-1.5">
                  <div className="flex items-center gap-2">
                    ...
                    />
                    <span className="text-xs text-muted-foreground">
                      {t("companySettings.mibUnit", { defaultValue: "MiB" })}
                    </span>
                  </div>
                  {!attachmentMaxValid && (
                    <span className="text-xs text-destructive">
                      {t("companySettings.attachmentLimitInvalid", {
        ...
        <div className="flex items-center gap-2">
          ...
          >
            {generalMutation.isPending
              ...
              : t("companySettings.saveChanges", { defaultValue: "Save changes" })}
          </Button>
          {generalMutation.isSuccess && (
            <span className="text-xs text-muted-foreground">
              {t("companySettings.saved", { defaultValue: "Saved" })}
            </span>
          )}
          {generalMutation.isError && (
            <span className="text-xs text-destructive">
              {generalMutation.error instanceof Error
                  ...
                  : t("companySettings.saveFailed", { defaultValue: "Failed to save" })}
            </span>
          )}
        </div>
      )}
      ...
      <div className="max-w-2xl space-y-4" data-testid="company-settings-team-section">
        <div className="text-xs font-medium text-muted-foreground uppercase tracking-wide">
          {t("companySettings.hiring", { defaultValue: "Hiring" })}
        </div>
        <div>
          <ToggleField
      ...
      <div className="space-y-4">
        <div className="text-xs font-medium text-destructive uppercase tracking-wide">
          {t("companySettings.dangerZone", { defaultValue: "Danger Zone" })}
        </div>
        <div className="space-y-3 bg-destructive/5 px-4 py-4">
          ...
          <div className="flex items-center gap-2">
            ...
            >
              {archiveMutation.isPending
                ? t("companySettings.archiving", { defaultValue: "Archiving..." })
                : selectedCompany.status === "archived"
                ? t("companySettings.alreadyArchived", { defaultValue: "Already archived" })
                : t("companySettings.archiveCompany", { defaultValue: "Archive company" })}
            </Button>
            {archiveMutation.isError && (
              <span className="text-xs text-destructive">
                {archiveMutation.error instanceof Error
                  ? archiveMutation.error.message
                  : t("companySettings.archiveFailed", { defaultValue: "Failed to archive company" })}
              </span>
            )}
          </div>
        </div>
