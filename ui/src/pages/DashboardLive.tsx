...
export function DashboardLive() {
  ...
  useEffect(() => {
    setBreadcrumbs([
      ...
      { label: t("dashboardLive.breadcrumb", { defaultValue: "Live runs" }) },
    ]);
  }, [setBreadcrumbs, t]);
    ...
    <div className="space-y-5">
      <div className="flex flex-col gap-3 sm:flex-row sm:items-end sm:justify-between">
        ...
        <div className="text-sm text-muted-foreground">
          {t("dashboardLive.showingUpTo", { defaultValue: "Showing up to {{count}}", count: DASHBOARD_LIVE_RUN_LIMIT })}
        </div>
      </div>

      <ActiveAgentsPanel
        companyId={selectedCompanyId}
        title={t("dashboardLive.panelTitle", { defaultValue: "Active / recent" })}
        ...
        emptyMessage={t("dashboardLive.empty", { defaultValue: "No active or recent agent runs." })}
