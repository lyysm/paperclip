...
export function GoalDetail() {
  ...
  const uploadImage = useMutation({
    mutationFn: async (file: File) => {
      if (!resolvedCompanyId) throw new Error(t("goalDetail.noCompanySelected", { defaultValue: "No company selected" }));
      ...
      <Tabs defaultValue="children">
        <TabsList>
          <TabsTrigger value="children">
            {t("goalDetail.subGoals", { defaultValue: "Sub-Goals ({{count}})", count: childGoals.length })}
          </TabsTrigger>
          <TabsTrigger value="projects">
            {t("goalDetail.projects", { defaultValue: "Projects ({{count}})", count: linkedProjects.length })}
          </TabsTrigger>
        </TabsList>
        ...
        <TabsContent value="children" className="mt-4 space-y-3">
          <div className="flex items-center justify-start">
            ...
            >
              ...
              {t("goalDetail.addSubGoal", { defaultValue: "Sub Goal" })}
            </Button>
          </div>
          {childGoals.length === 0 ? (
