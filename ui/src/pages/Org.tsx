...
export function Org() {
  ...
  useEffect(() => {
    setBreadcrumbs([{ label: t("orgPage.breadcrumb", { defaultValue: "Org Chart" }) }]);
  }, [setBreadcrumbs, t]);
  ...
  if (!selectedCompanyId) {
    return <EmptyState icon={GitBranch} message={t("orgPage.selectCompany", { defaultValue: "Select a company to view org chart." })} />;
  }
